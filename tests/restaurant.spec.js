...
describe('10 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    // ```
    const obj01 = createMenu({ food: {}, drink: {} });
    obj01.order('coxinha');
    
    expect(obj01.consumption).toEqual(['coxinha']);
    ...
    obj01.order('sopa');
    obj01.order('sashimi');
    expect(obj01.consumption).toEqual(['coxinha', 'agua', 'sopa', 'sashimi']);
    ...
    // ```
    const obj02 = createMenu({ food: {coxinha: 4.5} , drink: {agua: 3} });
    obj02.order('coxinha');
    obj02.order('agua');
    obj02.order('coxinha');
    expect(obj02.consumption).toEqual(['coxinha', 'agua', 'coxinha']);
    ...
    // ```
    expect(obj02.pay()).toBeCloseTo(13.2);
